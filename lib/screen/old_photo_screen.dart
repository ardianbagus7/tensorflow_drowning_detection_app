...
class OldPhotoScreen extends StatefulWidget {
  const OldPhotoScreen({super.key});

  @override
  State<OldPhotoScreen> createState() => _OldPhotoScreenState();
}

class _OldPhotoScreenState extends State<OldPhotoScreen> {
